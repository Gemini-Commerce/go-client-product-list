...
// ProductlistGetProductListByCodeResponse Defines the structure for GetProductListByCodeResponse.
...
func (o *ProductlistGetProductListByCodeResponse) IsSetList() bool {
	if o != nil && !IsNil(o.List) {
		return true
	}
