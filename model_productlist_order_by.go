...
// ProductlistOrderBy Defines sorting criteria for listing or searching operations, including field and direction.
type ProductlistOrderBy struct {
	// Field field of type string.
...
func (o *ProductlistOrderBy) IsSetField() bool {
	if o != nil && !IsNil(o.Field) {
		return true
	}
...
func (o *ProductlistOrderBy) IsSetDirection() bool {
	if o != nil && !IsNil(o.Direction) {
		return true
	}
